...
CREATE TABLE `utilisateur` (
  `uti_id` tinyint(3) UNSIGNED NOT NULL,
  ...
  `uti_confirmation` char(28) NOT NULL,
  `uti_actif` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Les comptes doivent être activés par le super admin.'
...
INSERT INTO `utilisateur` (`uti_id`, `uti_courriel`, `uti_mdp`, `uti_dcc`, `uti_confirmation`, `uti_actif`) VALUES
(1, 'test@test.com', '$2y$10$.1JzMuqZDozW3ichpyhLVuMbJxWj.S4I1ijAVqRhO1UKsU7UhB8dO', '2022-07-13 17:30:38', 'leila62cf00f82233e1.65921664', 1);
...
--
ALTER TABLE `utilisateur`
  MODIFY `uti_id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
